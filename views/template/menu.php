      ...
      <div class="container">
        <a class="navbar-brand" href="<?php echo BASE_URL; ?>">BasicPHP Starter</a>
          <ul class="nav nav-pills">
            <li class="nav-item <?php if (Basicphp::url_path(1) == '') echo 'active'; ?>">
              <a class="nav-link" href="<?php echo BASE_URL; ?>">Home</a>
            </li>
            <li class="nav-item <?php if (Basicphp::url_path(1) == 'encryption') echo 'active'; ?>">
              <a class="nav-link" href="<?php echo BASE_URL; ?>encryption">Encryption</a>
            </li>
            <li class="nav-item <?php if (Basicphp::url_path(1) == 'request') echo 'active'; ?>">
              <a class="nav-link" href="<?php echo BASE_URL; ?>request">Request</a>
            </li>
            <li class="dropdown <?php if (Basicphp::url_path(1) == 'post') echo 'active'; ?>">
            ...
            <li class="nav-item <?php if (Basicphp::url_path(1) == 'sample' && Basicphp::url_path(2) == 'route') echo 'active'; ?>">
